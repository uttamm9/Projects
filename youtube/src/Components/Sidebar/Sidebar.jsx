...
const Sidebar = ({sidebar,category,setCategory}) => {
  return (
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
      ...
      <div className={`side-links ${category===12?"active":""}`} onClick = {()=>setCategory(12)}>
      ...
      <div className="subcribe-list">
        ...
        <div className='side-links'>
          <img src={jack} alt="" /> <p>The uttam</p>
        </div>
        <div className='side-links'>
          <img src={simon} alt="" /> <p>carry</p>
        </div>
        <div className='side-links'>
          <img src={tom} alt="" /> <p>aksay</p>
        </div>
        <div className='side-links'>
          <img src={megan} alt="" /> <p>5-min-craft</p>
        </div>
        <div className='side-links'>
          <img src={cameron} alt="" /> <p>New Delhi</p>
        </div>
