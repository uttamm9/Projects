...
const Feed = ({category}) => {
  ...
  return (
    <div className="feed">
      <Link to={`video/20/43251`} className='card'>
        <img src={thumbnain1} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </Link>
      <div className='card'>
        <img src={thumbnain2} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain3} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain4} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain5} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain6} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain7} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div>
      <div className='card'>
        <img src={thumbnain8} alt="" />
        <h2>Best channel to learn coding that help you</h2>
        <h3>Greetstack</h3>
        <p>15k views &bull; 2 day ago</p>
      </div> 
